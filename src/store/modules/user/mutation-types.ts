...
export const USER_CURRENT_FACILITY_LOCATION_UPDATED = SN_USER + '/CURRENT_FACILITY_LOCATION_UPDATED'
export const USER_FACILITY_LOCATIONS_UPDATED = SN_USER + '/FACILITY_LOCATIONS_UPDATED'