          ...
          <div class="doc-meta" v-if="!isTOReceived()">
            <ion-item button lines="none" @click="openTOReceivingInstructions">
              ...
              <ion-label slot="end">
                ...
                <p><ion-text color="danger">{{ translate("This transfer orders can only be received on one device at a time. Make sure this transfer order is not open on any other device") }}</ion-text></p>
